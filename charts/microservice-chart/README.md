...
![Version: 8.0.4](https://img.shields.io/badge/Version-8.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.0](https://img.shields.io/badge/AppVersion-0.0.0-informational?style=flat-square)
...
| imagePullSerets | list | `[]` | imagePullSecrets: use a Secret to pull an image from a private container image registry or repository |
